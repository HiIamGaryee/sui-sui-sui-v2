...
interface MarketplaceContextType {
  ...
  addItem: (item: Omit<MarketplaceItem, 'id' | 'likes' | 'inEscrow' | 'createdAt'>) => void;
...
const initialItems: MarketplaceItem[] = [
  ...
  },
  {
    ...
    escrowDuration: 14,
    listingType: 'escrow',
    escrowBuyerAddress: '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef',
  },
  {
    id: 3,
    title: 'Vintage Collection #23',
    price: '200',
    image: 'https://images.unsplash.com/photo-1609205807107-e8ec6120f9de?w=800',
  ...
  },
  {
    ...
    escrowDuration: 30,
    listingType: 'escrow',
    escrowBuyerAddress: '0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890',
  },
  {
    id: 6,
...
export const MarketplaceProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const addItem = (newItem: Omit<MarketplaceItem, 'id' | 'likes' | 'inEscrow' | 'createdAt'>) => {
      ...
      return prev.map(item => {
        if (item.id === id) {
          ...
          Object.keys(updates).forEach(key => {
            ...
            if (updateKey === 'id' || updateKey === 'seller' || updateKey === 'createdAt') {
              return;
            }
          ...
          if (updates.listingType === 'escrow' && updates.escrowBuyerAddress !== undefined) {
